"""
Django settings for Tsaiwimon project.
"""
import os
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'django_filters',
    # 'django_extensions',  <--- คอมเมนต์ปิดไว้ชั่วคราว ป้องกัน Error กรณีที่ยังไม่ได้ติดตั้ง
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # <--- อนุญาตให้คนทั่วไปดูหน้าเว็บได้โดยไม่ต้องล็อกอินก่อน
    ],
